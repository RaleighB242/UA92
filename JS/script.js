...
if (IsinCart === false) {
  ...
  <div class="d-flex flex-row shadow-sm card cart-items mt-2 mb-3 animated flipInX">
    ...
    <div class="p-2 mt-3 ml-auto">
        <button class="btn badge badge-dark" type="button" data-action="increase-item">&plus;
    </div>
    <div class="p-2 mt-3">
      <p class="text-success cart_item_quantity">${product.quantity}</p>
    </div>
    <div class="p-2 mt-3">
      <button class="btn badge badge-info badge" type="button" data-action="decrease-item">&minus;
    </div>
    <div class="p-2 mt-3">
